...
type
  TSynPasSyg = class(TSynCustomHighlighter)
  private
    fAsmStart: Boolean;
    fRange: TRangeState;
    fLine: PChar;
...
procedure TSynPasSyg.InitIdent;
var
  I: Integer;
...
function TSynPasSyg.KeyHash(ToHash: PChar): Integer;
begin
  Result := 0;
...
function TSynPasSyg.KeyComp(const aKey: string): Boolean;
var
  I: Integer;
  Temp: PChar;
begin
...
function TSynPasSyg.Func25: TtkTokenKind;
begin
  if KeyComp('Far') then
    Result := tkKey
  else
...
function TSynPasSyg.Func27: TtkTokenKind;
begin
...
function TSynPasSyg.Func28: TtkTokenKind;
begin
  if KeyComp('Is') then
    Result := tkKey
...
function TSynPasSyg.Func29: TtkTokenKind;
begin
  if KeyComp('on') then
    Result := tkKey
  else
...
function TSynPasSyg.Func32: TtkTokenKind;
begin
...
function TSynPasSyg.Func33: TtkTokenKind;
begin
  if KeyComp('Or') then
    Result := tkKey
...
function TSynPasSyg.Func35: TtkTokenKind;
begin
  if KeyComp('Nil') then
    Result := tkKey
...
function TSynPasSyg.Func37: TtkTokenKind;
begin
...
function TSynPasSyg.Func38: TtkTokenKind;
begin
...
function TSynPasSyg.Func39: TtkTokenKind;
begin
  if KeyComp('For') then
    Result := tkKey
...
function TSynPasSyg.Func40: TtkTokenKind;
begin
...
function TSynPasSyg.Func41: TtkTokenKind;
begin
...
function TSynPasSyg.Func42: TtkTokenKind;
begin
...
function TSynPasSyg.Func44: TtkTokenKind;
begin
  if KeyComp('Set') then
    Result := tkKey
...
function TSynPasSyg.Func45: TtkTokenKind;
begin
  if KeyComp('Shr') then
    Result := tkKey
  else
...
function TSynPasSyg.Func46: TtkTokenKind;
begin
...
function TSynPasSyg.Func47: TtkTokenKind;
begin
...
function TSynPasSyg.Func49: TtkTokenKind;
begin
  if KeyComp('Not') then
    Result := tkKey
  else
...
function TSynPasSyg.Func52: TtkTokenKind;
begin
...
function TSynPasSyg.Func54: TtkTokenKind;
begin
...
function TSynPasSyg.Func55: TtkTokenKind;
begin
...
function TSynPasSyg.Func56: TtkTokenKind;
begin
...
function TSynPasSyg.Func57: TtkTokenKind;
begin
...
function TSynPasSyg.Func59: TtkTokenKind;
begin
...
function TSynPasSyg.Func60: TtkTokenKind;
begin
...
function TSynPasSyg.Func61: TtkTokenKind;
begin
...
function TSynPasSyg.Func63: TtkTokenKind;
begin
...
function TSynPasSyg.Func64: TtkTokenKind;
begin
...
function TSynPasSyg.Func65: TtkTokenKind;
begin
...
function TSynPasSyg.Func66: TtkTokenKind;
begin
...
function TSynPasSyg.Func69: TtkTokenKind;
begin
...
function TSynPasSyg.Func71: TtkTokenKind;
begin
...
function TSynPasSyg.Func73: TtkTokenKind;
begin
...
function TSynPasSyg.Func75: TtkTokenKind;
begin
...
function TSynPasSyg.Func76: TtkTokenKind;
begin
...
function TSynPasSyg.Func79: TtkTokenKind;
begin
...
function TSynPasSyg.Func81: TtkTokenKind;
begin
...
function TSynPasSyg.Func84: TtkTokenKind;
begin
...
function TSynPasSyg.Func85: TtkTokenKind;
begin
...
function TSynPasSyg.Func87: TtkTokenKind;
begin
...
function TSynPasSyg.Func88: TtkTokenKind;
begin
...
function TSynPasSyg.Func91: TtkTokenKind;
begin
...
function TSynPasSyg.Func92: TtkTokenKind;
begin
...
function TSynPasSyg.Func94: TtkTokenKind;
begin
...
function TSynPasSyg.Func95: TtkTokenKind;
begin
...
function TSynPasSyg.Func96: TtkTokenKind;
begin
...
function TSynPasSyg.Func97: TtkTokenKind;
begin
...
function TSynPasSyg.Func98: TtkTokenKind;
begin
...
function TSynPasSyg.Func99: TtkTokenKind;
begin
...
function TSynPasSyg.Func100: TtkTokenKind;
begin
...
function TSynPasSyg.Func101: TtkTokenKind;
begin
...
function TSynPasSyg.Func102: TtkTokenKind;
begin
...
function TSynPasSyg.Func103: TtkTokenKind;
begin
...
function TSynPasSyg.Func105: TtkTokenKind;
begin
...
function TSynPasSyg.Func106: TtkTokenKind;
begin
...
function TSynPasSyg.Func108: TtkTokenKind;
begin
...
function TSynPasSyg.Func112: TtkTokenKind;
begin
...
function TSynPasSyg.Func117: TtkTokenKind;
begin
...
function TSynPasSyg.Func126: TtkTokenKind;
begin
...
function TSynPasSyg.Func129: TtkTokenKind;
begin
...
function TSynPasSyg.Func132: TtkTokenKind;
begin
...
function TSynPasSyg.Func133: TtkTokenKind;
begin
...
function TSynPasSyg.Func136: TtkTokenKind;
begin
...
function TSynPasSyg.Func141: TtkTokenKind;
begin
...
function TSynPasSyg.Func143: TtkTokenKind;
begin
...
function TSynPasSyg.Func166: TtkTokenKind;
begin
...
function TSynPasSyg.Func168: TtkTokenKind;
begin
...
function TSynPasSyg.Func191: TtkTokenKind;
begin
...
function TSynPasSyg.AltFunc: TtkTokenKind;
begin
  Result := tkIdentifier
end;

function TSynPasSyg.IdentKind(MayBe: PChar): TtkTokenKind;
var
  HashKey: Integer;
begin
  fToIdent := MayBe;
...
procedure TSynPasSyg.MakeMethodTables;
var
  I: Char;
begin
  for I := #0 to #255 do
...
constructor TSynPasSyg.Create(AOwner: TComponent);
begin
...
procedure TSynPasSyg.SetLine(NewValue: string; LineNumber:Integer);
begin
...
procedure TSynPasSyg.AddressOpProc;
begin
  fTokenID := tkSymbol;
  inc(Run);
...
procedure TSynPasSyg.AsciiCharProc;
begin
  fTokenID := tkChar;
  Inc(Run);
...
procedure TSynPasSyg.BraceOpenProc;
begin
  if (fLine[Run + 1] = '$') then
  begin
...
procedure TSynPasSyg.ColonOrGreaterProc;
begin
  fTokenID := tkSymbol;
  inc(Run);
  if fLine[Run] = '=' then inc(Run);
...
procedure TSynPasSyg.IdentProc;
begin
...
procedure TSynPasSyg.IntegerProc;
begin
  inc(Run);
  fTokenID := tkHex;
  while FLine[Run] in ['0'..'9', 'A'..'F', 'a'..'f'] do
...
procedure TSynPasSyg.LowerProc;
begin
  fTokenID := tkSymbol;
  inc(Run);
...
procedure TSynPasSyg.NullProc;
begin
  fTokenID := tkNull;
end; { NullProc }

procedure TSynPasSyg.NumberProc;
begin
  Inc(Run);
  fTokenID := tkNumber;
...
procedure TSynPasSyg.PointProc;
begin
  fTokenID := tkSymbol;
  inc(Run);
  if fLine[Run] in ['.', ')'] then
...
procedure TSynPasSyg.RoundOpenProc;
begin
  Inc(Run);
  case fLine[Run] of
    '*':
...
procedure TSynPasSyg.SemicolonProc;
begin
  Inc(Run);
  fTokenID := tkSymbol;
...
procedure TSynPasSyg.SlashProc;
begin
  Inc(Run);
...
procedure TSynPasSyg.SpaceProc;
begin
  inc(Run);
  fTokenID := tkSpace;
...
procedure TSynPasSyg.StringProc;
  {
...
procedure TSynPasSyg.SymbolProc;
begin
  inc(Run);
  fTokenID := tkSymbol;
end;

procedure TSynPasSyg.UnknownProc;
begin
...
function TSynPasSyg.GetDefaultAttribute(Index: integer):
...
function TSynPasSyg.GetEol: Boolean;
begin
  Result := fTokenID = tkNull;
end;

function TSynPasSyg.GetToken: string;
var
  Len: LongInt;
begin
  Len := Run - fTokenPos;
...
function TSynPasSyg.GetTokenID: TtkTokenKind;
begin
...
function TSynPasSyg.GetTokenAttribute: TSynHighlighterAttributes;
begin
  case GetTokenID of
...
function TSynPasSyg.GetTokenKind: integer;
begin
  Result := Ord(GetTokenID);
end;

function TSynPasSyg.GetTokenPos: Integer;
begin
  Result := fTokenPos;
end;

function TSynPasSyg.GetRange: Pointer;
begin
  Result := Pointer(fRange);
end;

procedure TSynPasSyg.SetRange(Value: Pointer);
begin
  fRange := TRangeState(Value);
end;

procedure TSynPasSyg.ResetRange;
begin
  fRange:= rsUnknown;
end;

procedure TSynPasSyg.EnumUserSettings(DelphiVersions: TStrings);
begin
...
function TSynPasSyg.UseUserSettings(VersionIndex: integer): boolean;
...
{$ELSE}
  Result := False;
{$ENDIF}
end; { TSynPasSyg.UseUserSettings }

function TSynPasSyg.GetIdentChars: TSynIdentChars;
begin
  Result := TSynValidStringChars;
end;

function TSynPasSyg.GetSampleSource: string;
begin
...
class function TSynPasSyg.GetLanguageName: string;
begin
  Result := SYNS_LangPascal;
end;

class function TSynPasSyg.GetCapabilities: TSynHighlighterCapabilities;
begin
  Result := inherited GetCapabilities + [hcUserSettings];
end;

function TSynPasSyg.IsFilterStored: boolean;
begin
  Result := fDefaultFilter <> SYNS_FilterPascal;
end;

procedure TSynPasSyg.SetDelphiVersion(const Value: TDelphiVersion);
begin
...
procedure TSynPasSyg.SetPackageSource(const Value: Boolean);
begin
...
initialization
  MakeIdentTable;
{$IFNDEF SYN_CPPB_1}
  RegisterPlaceableHighlighter(TSynPasSyg);
{$ENDIF}
end.
