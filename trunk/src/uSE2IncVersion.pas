...
const
  ...
  C_UnitSource = 
        ...
        '  if not Convert.TryStrToInt(versionString.Copy(1, iPos - 1), v1) then' + #13#10 + 
        '     raise EConvertError.Create(''Invalid number found'');' + #13#10 + 
        '  versionString := versionString.Copy(iPos + 1);' + #13#10 + 
        #13#10 + 
        '  iPos := versionString.IndexOf(''.'');' + #13#10 + 
        '  if iPos = 0 then' + #13#10 + 
        '  begin' + #13#10 + 
        ...
        '    exit;' + #13#10 + 
        '  end;' + #13#10 + 
        '  if not Convert.TryStrToInt(versionString.Copy(1, iPos - 1), v2) then' + #13#10 + 
        '     raise EConvertError.Create(''Invalid number found'');' + #13#10 + 
        '  versionString := versionString.Copy(iPos + 1);' + #13#10 + 
        #13#10 + 
        #13#10 + 
        ...
        '    exit;' + #13#10 + 
        '  end;' + #13#10 + 
        '  if not Convert.TryStrToInt(versionString.Copy(1, iPos - 1), v3) then' + #13#10 + 
        '     raise EConvertError.Create(''Invalid number found'');' + #13#10 + 
        #13#10 + 
        #13#10 + 
        '  if not Convert.TryStrToInt(versionString.Copy(iPos + 1), v4) then' + #13#10 + 
        '     raise EConvertError.Create(''Invalid number found'');' + #13#10 + 
        #13#10 + 
